        ...
        <>
                    ...
                    <div className={styles.header__bottom}>
                        <div className={styles.header__bottom_menu}>
                            ...
                            <div className={styles.header__bottom_menu_right}>
                                ...
                                <motion.svg onClick={() => router.push('/cart')} initial={'hidden'} animate={'visible'} variants={opacityXPlusVariant} custom={2} className={styles.cart_ico} width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={styles.header_phone}>
                ...
                <div className={`${styles.header_phone__menu} ${isMenu ? styles.active : ''}`}>
                    {navigation.map((item) => {
                        return <Link key={item.name} href={item.href}><a onClick={handleMenuStatus}>{item.name}</a></Link>
                    })}
                </div>
            </div>
        </>
