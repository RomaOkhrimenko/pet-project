...
const Prompt = () => {
    return (
        <div  className={styles.prompt}>
            <motion.div whileInView={'visible'} initial={'hidden'} viewport={{amount: 1, once: true}}>
                <motion.h2 variants={opacityYVariant} className={styles.prompt__title}>Як обрати алкогольні напої до святкової події?</motion.h2>
                <motion.p variants={opacityXMinusVariant} className={styles.prompt__text}>Який напій Ви хотіли б обрати до святкового столу залежить в більшості від Ваших вподобань та смаків гостей, але важливо не забувати прості правила підбору напоїв, щоб не зіпсувати його смак. Бо навіть якісний алкоголь може смакувати не виграшно із деякими продуктами.</motion.p>
            </motion.div>
                <motion.div className={styles.prompt_block_container} whileInView={'visible'} initial={'hidden'} viewport={{amount: 0.2, once: true}}>
                <MPromptBlock variants={opacityYVariant} custom={1} img={'./images/png/prompt1.png'} text={
                    <p>
                ...
                <MPromptBlock variants={opacityYVariant} custom={2} img={'./images/png/prompt2.png'} text={
                    <p>
                ...
                <MPromptBlock variants={opacityYVariant} custom={3} img={'./images/png/prompt3.png'} text={
                    <p>
